...
def training_args():
    parser=argparse.ArgumentParser(description='CNN_models')
    ...
    #params_LSTM
    parser.add_argument('--neurons', default=256, type=int,
                        help='Neurons')
...
# build model
model = build_model_CNN(args.neurons,args.fpl,args.kernel_size,args.dp,dbX.shape[1],dbX.shape[2])
#model = build_model_CNN(args.neurons,args.dp,args.rdp,dbX.shape[1],dbX.shape[2])
print(model.summary())
...
model_path = 'CNN_models/1000_Structures/CNN_1000_BS_32_Lr_1e_3_4_5_epochs_500_Lr_Adap__/CNN_1000_Model_Lr_adap'+ timestampStr                 
model_path1 = 'CNN_models/1000_Structures/CNN_1000_BS_32_Lr_1e_3_4_5_epochs_500_Lr_Adap__/CNN_1000_Model_Lr_adap' + timestampStr
