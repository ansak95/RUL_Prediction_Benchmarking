...
def training_args():
    parser=argparse.ArgumentParser(description='GRU_model')
...
# build model
model = build_model_GRU(args.neurons,args.dp,args.rdp,dbX.shape[1],dbX.shape[2])
print(model.summary())
...
model_path = 'GRU_models/1000_Structures/GRU_1000_BS_32_Lr_1e_3_4_5_epochs_500_Lr_Adap__/GRU_1000_Model_Lr_adap'+ timestampStr                 
model_path1 = 'GRU_models/1000_Structures/GRU_1000_BS_32_Lr_1e_3_4_5_epochs_500_Lr_Adap__/GRU_1000_Model_Lr_adap' + timestampStr
