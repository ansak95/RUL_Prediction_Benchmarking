...
def training_args():
    parser=argparse.ArgumentParser(description='LSTM_model')
...
# build model
model = build_model_LSTM(args.neurons,args.dp,args.rdp,dbX.shape[1],dbX.shape[2])
print(model.summary())
...
model_path = 'LSTM_models/1000_Structures/LSTM_1000_BS_32_Lr_1e_3_4_5_epochs_500_Lr_Adap/LSTM_1000_Model_Lr_adap'+ timestampStr                 
model_path1 = 'LSTM_models/1000_Structures/LSTM_1000_BS_32_Lr_1e_3_4_5_epochs_500_Lr_Adap/LSTM_1000_Model_Lr_adap' + timestampStr
