...
from Models_reg import build_model_GRU
from Models_reg import build_model_CNN
from Models_reg import build_model_TCN
...
def training_args():
    parser=argparse.ArgumentParser(description='TCN_model')
    ...
    parser.add_argument('--neurons', default=64, type=int,
                        help='Neurons')
    parser.add_argument('--fpl', default = 25, type=int,
                       help = 'Filters per layers')
    parser.add_argument('--kernel_size', default=9, type = int,
                       help = 'Kernel_size')
    parser.add_argument('--nb_stacks', default = 8, type=int, 
                       help = 'number of tcn stacks')
...
# build model
model = build_model_TCN(args.fpl,args.kernel_size,args.nb_stacks,args.dp,dbX.shape[1],dbX.shape[2])
print(model.summary())
...
model_path = 'TCN_models/1000_Structures/TCN_1000_8_nbstack_BS_32_Lr_1e_3_4_5_epochs_500_Lr_Adap__/TCN_1000_nbstack_8_Model_Lr_adap'+ timestampStr                 
model_path1 = 'TCN_models/1000_Structures/TCN_1000_8_nbstack_BS_32_Lr_1e_3_4_5_epochs_500_Lr_Adap__/TCN_nbstack_8_1000_Model_Lr_adap' + timestampStr
